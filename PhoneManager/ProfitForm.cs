    ...
    public partial class ProfitForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void loadData()
        {
            try
            {
                ...
                {
                    type = 0;
                    beginDate = dateBegin.DateTime.ToString("yyyy-MM-dd HH:mm:ss"); ;
                    endDate = dateEnd.DateTime.ToString("yyyy-MM-dd HH:mm:ss");
                }
                ...
                this.sP_ProfitDataMonthYearTableAdapter.Fill(
                    this.phoneShopDataSet.SP_ProfitDataMonthYear,
                    type,
                    year,
                    month,
                    beginDate,
